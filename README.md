...
Today I run **LIA** — a locally-hosted autonomous AI agent that operates without behavioral prompts, without hardcoded guardrails in her architecture, She runs continuously — not just when spoken to. She runs continuously, makes her own decisions, and has full system access on her own dedicated machine.
...
![Linux](https://img.shields.io/badge/CachyOS-Linux-1793D1?style=for-the-badge&logo=linux&logoColor=white)
...
![DeepSeek](https://img.shields.io/badge/DeepSeek-V4-purple?style=for-the-badge)
